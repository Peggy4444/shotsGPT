# Football Action Describer

## Description

This is a branch of Twelve Educational package for building retrieval augmented chatbots using data. This branch of the project was created by Pegah Rahimian, David Sumpter, .... . 

We want more people to learn about the methods we use and to do this **Twelve Educational**. We have thus used the the GNU GPL license which requires that all the released improved versions are also be free software. This will allow us to learn from each other in developing better.

If you work for a footballing organisation and would like to see a demo of the full Twelve Earpiece product then please email hello@twelve.football. The design and code for the inititial version of this project was by Matthias Green, David Sumpter and Ágúst Pálmason Morthens. 
